/*
	Can Bus Frames as defined in "RoboSub 17 CAN Frames Rev.8.xlsx"
*/
...
tCAN Request_Response_HYDRAS_Bearing		= {.id = 408, .header.rtr = 0, .header.length = 6};
tCAN Request_Response_HYDRAS_Depth 			= {.id = 416, .header.rtr = 0, .header.length = 6};
tCAN Request_Response_HYDRAS_Bearing_RAW 	= {.id = 424, .header.rtr = 0, .header.length = 6};
tCAN Request_Response_HYDRAS_Depth_RAW 		= {.id = 432, .header.rtr = 0, .header.length = 6};

tCAN Request_Response_ESC1 		= {.id = 440, .header.rtr = 0, .header.length = 8};
tCAN Request_Response_ESC2 		= {.id = 448, .header.rtr = 0, .header.length = 8};
tCAN Request_Response_ESC3 		= {.id = 456, .header.rtr = 0, .header.length = 8};
tCAN Request_Response_ESC4 		= {.id = 464 .header.rtr = 0, .header.length = 8};
tCAN Request_Response_ESC5 		= {.id = 472, .header.rtr = 0, .header.length = 8};
tCAN Request_Response_ESC6 		= {.id = 480, .header.rtr = 0, .header.length = 8};
tCAN Request_Response_ESC7 		= {.id = 488, .header.rtr = 0, .header.length = 8};
tCAN Request_Response_ESC8 		= {.id = 496, .header.rtr = 0, .header.length = 8};
tCAN Request_Response_Weapon_status 	= {.id = 507, .header.rtr = 0, .header.length = 8};
tCAN Request_Response_Backplane_Current = {.id = 515, .header.rtr = 0, .header.length = 8};

//Data requests
tCAN Read_Request_SIB_Pressure 		= {.id = 524, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_SIB_Temp 		= {.id = 532, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_HYDRAS 		= {.id = 538, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_HYDRAS_RAW 		= {.id = 546, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_ESC_Vitals 		= {.id = 554, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_ESC1 			= {.id = 562, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_ESC2 			= {.id = 570, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_ESC3 			= {.id = 578, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_ESC4 			= {.id = 586, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_ESC5 			= {.id = 594, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_ESC6 			= {.id = 602, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_ESC7 			= {.id = 610, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_ESC8 			= {.id = 618, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_Weapon_status 	= {.id = 626, .header.rtr = 1, .header.length = 0};
tCAN Read_Request_Backplane_Current 	= {.id = 633, .header.rtr = 1, .header.length = 0};
